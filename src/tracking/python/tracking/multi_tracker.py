...
class MultiTracker:
    ...
    def get_slices(
        ...
        x_lowerb = obj.track_window[1] - self.overlap_margin
        if x_lowerb < 0:
            x_lowerb = 0
        x_upperb = obj.track_window[1] + obj.track_window[3] + self.overlap_margin
        if x_upperb > pre_tracked_frame.shape[0]:
            x_upperb = pre_tracked_frame.shape[0]
        y_lowerb = obj.track_window[0] - self.overlap_margin
        if y_lowerb < 0:
            y_lowerb = 0
        y_upperb = obj.track_window[0] + obj.track_window[2] + self.overlap_margin
